...
void add2DweightsGJet(){
  ...
  string FileName = "../NTuples/SinglePhoton_GJet_M95PTM25_DPT075_1208_Training.root";
  string FileNameW = "../NTuples/SinglePhoton_GJet_M95PTM25_DPT075_1208_Training_Proc.root";
 ...
 // TDirectory *dir_Photon = (TDirectory*)bigFile->Get("photonViewDumper/trees");
    ...
    TTree *t_PromtPhotons = (TTree*)bigFile->Get("promptPhotons");
    TTree *t_FakePhotons = (TTree*)bigFile->Get("fakePhotons");
