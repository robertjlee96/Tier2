...
dptCut = lambda tree: abs((tree.array('genPt')-tree.array('pt'))/tree.array('genPt')) < 0.075
ptCut = lambda tree: tree.array('pt') > 18.0
...
#input_values, target_values, orig_weights, train_weights, pt, scEta, input_vars = MoreVarsPtCutUtils.load_file(fin,geometry_selection)
...
model_name = "Model_MD18_LR03_M95PTM25_DPT075_T25PT18_OnlyPFPairs_NoPtReweight_UL2017_0109"
