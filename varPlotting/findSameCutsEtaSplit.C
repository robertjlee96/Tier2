...
void findSameCutsEtaSplit(bool etaSplit, bool diphotonCuts){
    ...
    for (int e = 0; e < nEta; e++){
        ...
        if(diphotonCuts == true){
            ...
            cutStringLeadIDMVA2 = "(leadGenMatchType != 1" + etaCutsLead[e] + massCut + kinCutLeadLoose + kinCutSubLoose;
            cutStringSubIDMVA2 = "(subGenMatchType != 1" + etaCutsSub[e] + massCut + kinCutSubLoose + kinCutLeadLoose;
        }
