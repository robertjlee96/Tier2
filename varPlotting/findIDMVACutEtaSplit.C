...
void findIDMVACutEtaSplit(bool etaSplit, bool diphotonCuts){
    gROOT->Reset();
    gStyle->SetPalette(1);
    ...
    string fileNameGJet = "../NTuples/GGH_And_GJets_M95PTM25_DPT075_HHovrE_Test25Percent_FixSplit_1222.root";
    ...
    for (int e = 0; e < nEta; e++){
        ...
        if(diphotonCuts == true){
            cutStringLeadPresel = "(leadGenMatchType != 1" + etaCutsLead[e] + massCut + kinCutLeadTight + preselLead + kinCutSubTight + preselSub + ")*weight";
            cutStringSubPresel = "(subGenMatchType != 1" + etaCutsSub[e] + massCut + kinCutSubTight + preselSub + kinCutLeadTight + preselLead + ")*weight";
            ...
            cutStringLeadIDMVA = "(leadGenMatchType != 1" + etaCutsLead[e] + massCut + kinCutLeadLoose + kinCutSubLoose;
            cutStringSubIDMVA = "(subGenMatchType != 1" + etaCutsSub[e] + massCut + kinCutSubLoose + kinCutLeadLoose;
        }
        if(diphotonCuts == false){
            cutStringLeadPresel = "(leadGenMatchType != 1" + etaCutsLead[e] + massCut + kinCutLeadTight + preselLead + ")*weight";
            cutStringSubPresel = "(subGenMatchType != 1" + etaCutsSub[e] + massCut + kinCutSubTight + preselSub + ")*weight";
            ...
            cutStringLeadIDMVA = "(leadGenMatchType != 1" + etaCutsLead[e] + massCut + kinCutLeadLoose;
            cutStringSubIDMVA = "(subGenMatchType != 1" + etaCutsSub[e] + massCut + kinCutSubLoose;// + ")*weight";
        }
