...
void addCutsGGH(){
    ...
    TFile* fileOut = TFile::Open("NTuples/SinglePhoton_GGH_M121to129_PTM15_DPT075_0122_Validation.root","RECREATE");
    ...
    Float_t hggMassP1,eventP1,genPtP1,genMatchTypeP1,ptP1,weightP1,scRawEP1,r9P1,sigmaIetaIetaP1,etaWidthP1,phiWidthP1,covIEtaIPhiP1,s4P1,phoIso03P1,chgIsoWrtChosenVtxP1,chgIsoWrtWorstVtxP1,scEtaP1,esEffSigmaRRP1,esEnergyOverRawEP1,rhoP1,hadTowOverEmP1,hadronicOverEmP1;
    ...
    Float_t hggMassP2,eventP2,genPtP2,genMatchTypeP2,ptP2,weightP2,scRawEP2,r9P2,sigmaIetaIetaP2,etaWidthP2,phiWidthP2,covIEtaIPhiP2,s4P2,phoIso03P2,chgIsoWrtChosenVtxP2,chgIsoWrtWorstVtxP2,scEtaP2,esEffSigmaRRP2,esEnergyOverRawEP2,rhoP2,hadTowOverEmP2,hadronicOverEmP2;
    ...
    Float_t hggMassF1,eventF1,genPtF1,genMatchTypeF1,ptF1,weightF1,scRawEF1,r9F1,sigmaIetaIetaF1,etaWidthF1,phiWidthF1,covIEtaIPhiF1,s4F1,phoIso03F1,chgIsoWrtChosenVtxF1,chgIsoWrtWorstVtxF1,scEtaF1,esEffSigmaRRF1,esEnergyOverRawEF1,rhoF1,hadTowOverEmF1,hadronicOverEmF1;
    ...
    Float_t hggMassF2 ,eventF2 ,genPtF2 ,genMatchTypeF2 ,ptF2 ,weightF2 ,scRawEF2 ,r9F2 ,sigmaIetaIetaF2 ,etaWidthF2 ,phiWidthF2 ,covIEtaIPhiF2 ,s4F2 ,phoIso03F2 ,chgIsoWrtChosenVtxF2 ,chgIsoWrtWorstVtxF2 ,scEtaF2 ,esEffSigmaRRF2 ,esEnergyOverRawEF2 ,rhoF2 ,hadTowOverEmF2 ,hadronicOverEmF2 ;
    ...
    while (myReader.Next()){
        ...
        if(((int)*eventIn)%2 == 0){
            ...
            if (*hggMassIn > 121 && *hggMassIn < 129  && *subGenMatchType == 1.0 && *subPt > 17.0 && *subPt/(*hggMassIn) > 0.15 && abs(*subGenPt-*subPt)/(*subPt) < 0.075){
                hggMassP2 = *hggMassIn;
                eventP2 = *eventIn;
