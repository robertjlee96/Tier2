...
void compIDMVAScores(){
    ...
    string fOutR = "outROC/GJetROC_LRSearch13_Endcap_0127.root";
    string fOutX = "idMVAPlots/GJetIDMVA_LRSearch13_Endcap_0127.root";
    ...
    string fileName[7];
    fileName[0] = "validationNTuples/0125/MD13_LR01_M95PTM15_OnlyPFPairs_UL2017_Validation_Endcap.root";
    fileName[1] = "validationNTuples/0125/MD13_LR02_M95PTM15_OnlyPFPairs_UL2017_Validation_Endcap.root";
    fileName[2] = "validationNTuples/0125/MD13_LR03_M95PTM15_OnlyPFPairs_UL2017_Validation_Endcap.root";
    fileName[3] = "validationNTuples/0125/MD13_LR04_M95PTM15_OnlyPFPairs_UL2017_Validation_Endcap.root";
    fileName[4] = "validationNTuples/0125/MD13_LR05_M95PTM15_OnlyPFPairs_UL2017_Validation_Endcap.root";
    fileName[5] = "validationNTuples/0125/MD13_LR06_M95PTM15_OnlyPFPairs_UL2017_Validation_Endcap.root";
    fileName[6] = "validationNTuples/0125/MD13_LR07_M95PTM15_OnlyPFPairs_UL2017_Validation_Endcap.root";
...
//    fileName[6] = "validationNTuples/0124/MD18_LR07_M95PTM15_OnlyPFPairs_UL2017_Validation_Endcap_0122.root";
    ...
    string labels[7];
    labels[0] = "MD 13 LR.01";
    labels[1] = "MD 13 LR.02";
    labels[2] = "MD 13 LR.03";
    labels[3] = "MD 13 LR.04";
    labels[4] = "MD 13 LR.05";
    labels[5] = "MD 13 LR.06";
    labels[6] = "MD 13 LR.07";
    
    string titleXGB = "XGBoost Score for GJet Endcap Prompt and Fake;yPred";
    string titleRoc = "RoC Curves for GJet Endcap";
...
//    THStack *fStack = new THStack("fStack",titleFake.c_str());
    ...
    for(int i = iLow; i < iHigh; i++){
        ...
        while (pReader.Next()) {
            ...
            hPrompt[i]->Fill(*yPredValsP,*weightP);
        }
        while (fReader.Next()) {
            hFake[i]->Fill(*yPredValsF,*weightF);
        }
...
//
        ...
        string nPStr = buff1;
        string labelP;
        if (i == iLow) labelP = labels[i] + " Prompt " + (nPStr + ")") + "(" + AUCStr.c_str() + ")";
        else labelP = labels[i] + " Prompt " + "(" + AUCStr.c_str() + ")";
